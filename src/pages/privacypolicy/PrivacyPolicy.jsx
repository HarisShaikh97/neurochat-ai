            ...
            <div className="h-full flex flex-row">
                ...
                <div className="my-10 px-10 flex-1 flex flex-col">
                    ...
                    <div className="text-gray-500 text-sm flex flex-col gap-3">
                        <div>Last updated May 01, 2023</div>
                        <div>NeuroGPT is a product of <a href="https://neurocare.ai" className="text-bgblue underline">NeuroCare.AI</a> and is owned and operated by <a href="https://neurocare.ai" className="text-bgblue underline">NeuroCare.AI.</a></div>
                    </div>
                    ...
                    <div className="text-gray-500 text-sm flex flex-col gap-3">
                        <div>This privacy notice for <a href="https://neurocare.ai" className="text-bgblue underline">NeuroCare.AI</a> Inc. ({'"'}Company,{'"'} {'"'}we,{'"'} {'"'}us,{'"'} or {'"'}our{'"'}), describes how and why we might collect, store, use, and/or share ({'"'}process{'"'}) your information when you use our services ({'"'}Services{'"'}), such as when you:</div>
                        <ul className="list-disc pl-6 space-y-2">
                            <li>Visit our website at <a href="https://neurocare.ai" className="text-bgblue underline">https://neurocare.ai/</a>, or any website of ours that links to this privacy notice</li>
                            <li>Download and use our mobile application <a href="https://neurocare.ai" className="text-bgblue underline">(NeuroCare.AI)</a>, or any other application of ours that links to this privacy notice</li>
                    ...
                    <div className="text-gray-500 text-sm flex flex-col gap-3">
                        ...
                        <div className="mt-5">What personal information do we process?</div>
                        <div>When you visit, use, or navigate our Services, we may process personal information depending on how you interact with <a href="https://neurocare.ai" className="text-bgblue underline">NeuroCare.AI</a> Inc. and the Services, the choices you make, and the products and features you use.</div>
                        <div className="mt-5">Do we process any sensitive personal information?</div>
                        ...
                        <div className="mt-5">Do we receive any information from third parties?</div>
                        <div>We do not receive any information from third parties.</div>
                        <div className="mt-5">How do you process my information?</div>
                        ...
                        <div className="mt-5">In what situations and with which parties do you share personal information?</div>
                        <div>We may share information in specific situations and with specific third parties.</div>
                        <div className="mt-5">How do you keep my information safe?</div>
                        ...
                        <div className="mt-5">What are our rights?</div>
                        ...
                        <div className="mt-5">How do I exercise my rights?</div>
                        <div>The easiest way to exercise your rights is by filling out our data subject request form available <a href="https://app.termly.io/notify/de38850a-96ac-441b-9af4-f97def67629d" className="text-bgblue underline">here</a>, or by contacting us. We will consider and act upon any request in accordance with applicable data protection laws.</div>
                        <div>Want to learn more about what <a href="https://neurocare.ai" className="underline">NeuroCare.AI</a> Inc. does with any information we collect? Kindly click the details below.</div>
                    </div>
                    ...
                    <div className="text-gray-500 text-sm flex flex-col gap-3">
                        ...
                        <div className="mt-5">Personal Information Provided by You. The personal information that we collect depends on the context of your interactions with us and the Services, the choices you make, and the products and features you use. The personal information we collect may include the following:</div>
                        <ul className="list-disc pl-6 space-y-2">
                            <li>names</li>
                            <li>phone numbers</li>
                        ...
                        <div className="mt-5">Social Media Login Data. We may provide you with the option to register with us using your existing Apple or Google account details. If you choose to register in this way, we will collect the information described in the section called {'"'}HOW DO WE HANDLE YOUR SOCIAL LOGINS?{'"'} below.</div>
                        <div className="mt-5">Application Data. If you use our application(s), we also may collect the following information if you choose to provide us with access or permission:</div>
                        <div>Geolocation Information. We may request access or permission to track location-based information from your mobile device, either continuously or while you are using our mobile application(s), to provide certain location-based services. If you wish to change our access or permissions, you may do so in your device{"'"}s settings.</div>
                        <div>Mobile Device Access. We may request access or permission to certain features from your mobile device, including your mobile device{"'"}s Bluetooth, reminders, sensors, social media accounts, storage, calendar, microphone, camera, and other features. If you wish to change our access or permissions, you may do so in your device{"'"}s settings.</div>
                        <div>Mobile Device Data. We automatically collect device information (such as your mobile device ID, model, and manufacturer), operating system, version information, and system configuration information, device and application identification numbers, browser type and version, hardware model Internet service provider, and/or mobile carrier, and Internet Protocol (IP) address (or proxy server). If you are using our application(s), we may also collect information about the phone network associated with your mobile device, your mobile device’s operating system or platform, the type of mobile device you use, your mobile device’s unique device ID, and information about the features of our application(s) you accessed.</div>
                        <div>Push Notifications. We may request to send you push notifications regarding your account or certain features of the application(s). If you wish to opt-out from receiving these types of communications, you may turn them off in your device{"'"}s settings.</div>
                        ...
                        <div>Log and Usage Data. Log and usage data are service-related, diagnostic, usage, and performance information our servers automatically collect when you access or use our Services and which we record in log files. Depending on how you interact with us, this log data may include your IP address, device information, browser type, and settings and information about your activity in the Services (such as the date/time stamps associated with your usage, pages and files viewed, searches, and other actions you take such as which features you use), device event information (such as system activity, error reports (sometimes called {'"'}crash dumps{'"'}), and hardware settings).</div>
                        <div>Device Data. We collect device data such as information about your computer, phone, tablet, or other devices you use to access the Services. Depending on the device used, this device data may include information such as your IP address (or proxy server), device and application identification numbers, location, browser type, hardware model, Internet service provider and/or mobile carrier, operating system, and system configuration information.</div>
                        <div>Health & Wearable data. Health & Wearable information is stored on your device via Apple Health (HealthKit) or Google Fit. Information includes but is not limited to vitals, medications, allergies, sleep, activity, etc.</div>
                    </div>
                    ...
                    <div className="text-gray-500 text-sm flex flex-col gap-3">
                        ...
                        <div>If you are located in Canada, this section applies to you.</div>
                    ...
                    <div className="text-gray-500 text-sm flex flex-col gap-3">
                        ...
                        <div>If you are located in the EEA or UK and you believe we are unlawfully processing your personal information, you also have the right to complain to your local data protection supervisory authority. You can find their contact details here: <a href="https://ec.europa.eu/newsroom/article29/items/612080" className="text-bgblue underline">https://ec.europa.eu/justice/data-protection/bodies/authorities/index_en.htm</a></div>
                        <div>If you are located in Switzerland, the contact details for the data protection authorities are available here: <a href="https://www.edoeb.admin.ch/edoeb/en/home.html" className="text-bgblue underline">https://www.edoeb.admin.ch/edoeb/en/home.html</a></div>
                    ...
                    <div className="text-gray-500 text-sm flex flex-col gap-3">
                        ...
                        <div><a href="https://neurocare.ai" className="text-bgblue underline">NeuroCare.AI</a> Inc. has not disclosed or sold any personal information to third parties for a business or commercial purpose in the preceding twelve (12) months. <a href="https://neurocare.ai" className="text-bgblue underline">NeuroCare.AI</a> Inc. will not sell personal information in the future belonging to website visitors, users, and other consumers.</div>
                    ...
                    <div className="text-gray-500 text-sm flex flex-col gap-3">
                        ...
                        <div><a href="https://neurocare.ai" className="text-bgblue underline">NeuroCare.AI</a> Inc.</div>
