...
function Falcon() {
    ...
    const updateSubscription = async () => {
        ...
        const subscriptionData = {
            ...
            falconRemaining: currentSubscription?.falconRemaining - 1,
            ...
            <div className="h-full flex flex-row">
                <div className="w-96 flex flex-col gap-10 p-5">
                    ...
                    {agreed ? (
                        ...
                        <div className="flex flex-col gap-5">
                            <div className="text-lg font-semibold">Top Use cases for Falcon40B</div>
                            ...
                            <div className="flex flex-col gap-5 h-full">
                                <div className="flex flex-col gap-10 h-full overflow-y-auto px-10 pb-10">
                                    {selectedChat?.chat?.map((thread, key) => {
                                        return (
                                            <ChatMessage thread={thread} modelType='falcon' refreshAllChats={refreshAllChats} refreshChat={refreshChat} selectedChat={selectedChat} setSelectedChat={setSelectedChat} setShowTranslationPopup={setShowTranslationPopup} setTranslatedText={setTranslatedText} key={key} />
                                        )
                                    })}
                                ...
                                {currentSubscription?.falconRemaining > 0 ? (
                                    <form onSubmit={handleSubmit} className="flex flex-row gap-5 items-end px-10">
                                        ...
                                        <div className="flex flex-col items-center gap-2 pb-1">
                                            <div className="text-bgblue text-xs border border-bgblue rounded-full h-5 px-2 flex items-center justify-center">{currentSubscription?.falconRemaining}/5</div>
