        ...
        <Layout>
            ...
            <div className="h-full flex flex-row">
                {state?.palm_agreed ? (
                    ...
                    <div className="w-96 flex flex-col gap-10 p-5">
                        <div className="flex flex-col gap-5">
                            <div style={{fontSize: '22px', fontWeight: 'bold'}}>Top Use cases for PaLM2</div>
                        ...
                        {state?.palm_agreed ? (
                            ...
                            <div className="h-full flex flex-col justify-between px-10">
                                <div className="flex flex-col gap-10">
                                    <div style={{fontSize: '22px', fontWeight: 'bold'}}>About PaLM2</div>
                                ...
                                <div className="flex justify-end w-full">
                                    <button onClick={() => {dispatch({ type: 'SET_PALM_AGREED', payload: true })}} className="bg-bgblue text-white rounded-3xl" style={{height: '56px', width: '343px', fontSize: '16px', fontWeight: 'bold'}}>I Understand</button>
                                </div>
                            </div>
                        )}
                    </div>
