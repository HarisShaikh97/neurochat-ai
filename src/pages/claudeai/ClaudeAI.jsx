...
function ClaudeAI() {
    ...
    const updateSubscription = async () => {
        ...
        const subscriptionData = {
            ...
            claudeRemaining: state?.current_package?.claudeRemaining - 1,
                    ...
                    <div className="h-[80vh] pt-10 w-full">
                        {state?.claude_agreed ? (
                            <div className="flex flex-col gap-5 h-full">
                                ...
                                {state?.current_package?.claudeRemaining > 0 ? (
                                    <form onSubmit={handleSubmit} className="flex flex-row gap-5 items-end px-10">
                                        ...
                                        <div className="flex flex-col items-center gap-2 pb-1">
                                            {state?.current_package?.package === 'BASIC' && <div className="font-black border border-bgblue rounded-full flex items-center justify-center" style={{fontSize: '10px', height: '18px', width: '37px'}}>{state?.current_package?.claudeRemaining}/5</div>}
